  ...
  <div className="LandingPage"> 
        ...
        <div className='block1content'>
          ...
          <div className='block1top'>
            ...
            <div className='block1input'>
              <input type='text' value={username} onChange={handleOnTempChange} name='username' placeholder='Enter your email here' className='block1inputtxt'/>
              <input type='submit' value='Get started for free' onClick={() => handleSetDialogCall('alpha', true)} className='block1inputsubmit' />
            </div>
          </div>
    ...
    <div className='block5wrapper'>
      <div className='block5'>
        ...
        <RaisedButton label='Become an Alpha User' primary={true} onClick={() => handleSetDialogCall('alpha', true)} style={{width: '200px', margin: '10px'}} />
